...
To connect to remote neo4j you can use ssh tunnel
```
ssh -L 7474:localhost:7474  -L 7473:localhost:7473 -L 7687:localhost:7687 -L 7472:localhost:7472 ubuntu@ssh-premesti-se.trk.in.rs
```
