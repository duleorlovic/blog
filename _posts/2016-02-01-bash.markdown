...
~~~
xbindkeys -d > ~/.xbindkeysrc # create default configuration file ~/.xbindkeysrc
xbindkeys_show # to test configuration file
xbindkeys-config # gui
xbindkeys -k # too see command for your key combination
...
cat > ~/.xbindkeysrc <<HERE_DOC
#-*- shell-script -*-

"echo -e 'KeyStrRelease F6\nKeyStrPress a\nKeyStrRelease a' | xmacroplay :0"
  F6
