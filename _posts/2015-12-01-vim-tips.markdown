...
* `[l` `]l` ale errors
* `]b` buffers
* `]q` go next `[q` prev Quick fix, more are in `:help unimpaired-next`
...
* vim begginer tutorial `:help vimtutor` or run in shel `vimtutor`
...
# tasks and test for setup data could be very long
Metrics/BlockLength:
  Exclude:
    - "lib/**/*"
    - 'test/**/*'
